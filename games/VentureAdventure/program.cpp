...
int main()
{
    ...
    // start screen. could be expanded in future to be a main menu. no way to return to this screen unless game is lost or won, but there's currently no reason to want to return

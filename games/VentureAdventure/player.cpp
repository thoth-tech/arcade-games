...
player_data new_player()
{
    ...
    //commenting out theses line as number of gems collected are not actually stored here, this number is visual only. Will initialise it elsewhere. Bullets unused
    //result.gem = 0;
    //result.bullet  = 0;
